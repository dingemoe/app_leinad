import { div, h1, h2, h3, p, table, thead, tbody, tr, th, td, form, input, button, render, factory } from "https://raw.githubusercontent.com/dingemoe/app_leinad/477a87f32509b0ef9056f8c6d69dc6403aae9d81/classes/html.js";
import { setDefaultTheme } from "https://raw.githubusercontent.com/dingemoe/app_leinad/477a87f32509b0ef9056f8c6d69dc6403aae9d81/classes/theme.js";
...
const App = factory(() =>
  div().dracula().className("min-h-screen p-8").set([
    ...
    div().className("mt-12 p-6 bg-gray-800 rounded text-center").set([
      ...
      p().className("text-sm text-gray-500 mt-2").text("Framework: App Leinad v1.3.17 | Database: Deno KV | Theme: Dracula 🧛‍♂️"),
